...
export default async function ServiceDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="bg-[#F5F5F3]">
      <div className="relative bg-[#0B0B0C] pt-28 sm:pt-40 pb-16 sm:pb-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <h1 className="text-3xl sm:text-5xl font-bold text-white mt-2 mb-4">{service.name}</h1>
      ...
      <div className="max-w-4xl mx-auto px-5 sm:px-6 lg:px-8 py-12 sm:py-20">
